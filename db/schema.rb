...
ActiveRecord::Schema.define(version: 2022_08_13_125953) do
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.bigint "missing_item_id", null: false
    t.string "message"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  create_table "missing_items", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id"], name: "index_missing_items_on_user_id"
  end
  ...
  create_table "photos", force: :cascade do |t|
    ...
    t.bigint "user_id", null: false
    t.bigint "missing_item_id", null: false
    t.index ["missing_item_id"], name: "index_photos_on_missing_item_id"
